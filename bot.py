...
#         return
#
#     await message.bot.delete_message(chat_id=config.CHANNEL_ID, user_id=message.message_id)
#     await message.bot.kick_chat_member(chat_id=config.CHANNEL_ID, user_id=message.reply_to_message.from_user.id)
#
